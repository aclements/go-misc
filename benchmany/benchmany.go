...
// Usage:
//
//	benchmany run [-C git-dir] [-n iterations] <revision range>
//
//      benchmany plot [-C git-dir] <revision range>
//
// run
//
// "benchmany run" runs the benchmarks in the current directory
// <iterations> times for each revision in <revision range> and writes
...
// run" for the given <revision range> and outputs tables that can be
...
// TODO: Support printing list of log files names. Maybe even a
// subcommand to run benchstat on the right logs.
