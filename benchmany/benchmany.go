...
// run" for the given <commit or range> and plots the results of
// benchmarks over time.
//
// Plot supports various output formats. By default, it outputs a text
// table that can be used as input to most plotting programs. The
// -html option produces a Google Charts page that can be used to
// interactively view benchmark results.
//
// Plot supports a -filter flag that reduces noise in benchmark
// results using an adaptive Kolmogorov-Zurbenko (KZA) low-pass
// filter. This filter retains sharp changes in performance, so you
// can see exactly when significant changes happened, while smoothing
// out transient noise.
//
// Plot supports normalizing results to a baseline using the -baseline
// flag. This is useful when looking for relative changes, or when
// plotting many different benchmarks that may have wildly different
// expected results.
//
// List subcommand
//
